...
/** 获取WAF地域封禁支持的地域列表 */
export const DESCRIBE_AREABAN_SUPPORT_AREAS =
  "waf2/DescribeAreaBanSupportAreas";
/** 修改地域封禁中地域信息 */
...
/** 查询下载记录 */
export const DESCRIBE_ATTACK_DOWNLOAD_RECORDS =
  "waf2/DescribeAttackDownloadRecords";
/** 删除下载记录 */
...
/** Bot_V2 域名bot统计 */
export const DESCRIBE_BOT_AGGREGATE_DOMAINSTAT =
  "waf2/DescribeBotAggregateDomainStat";
/** 查询日志服务使用状况 */
export const DESCRIBE_CLS = "waf2/DescribeCLS";
/** 查询满足搜索条件的访问日志数量 */
export const DESCRIBE_ACCESSLOG_COUNT = "waf2/DescribeAccessLogCount";
/** 查询访问日志下载任务 */
export const DESCRIBE_ACCESS_DOWNLOAD_RECORDS =
  "waf2/DescribeAccessDownloadRecords";
/** 下载访问日志 */
...
/** Bot_V2 bot记录访问详情 */
export const DESCRIBE_BOT_RECORD_ITEMS = "waf2/DescribeBotRecordItems";
/** bot详情 */
export const DESCRIBE_BOT_RECORD_DETAIL = "waf2/DescribeBotRecordDetail";
...
/** Bot_V2 获取UCB预设策略 */
export const DESCRIBE_BOT_UCB_PREINSTALLRULE =
  "waf2/DescribeBotUCBPreinstallRule";
/** Bot_V2 UCB预设策略拷贝 */
...
export const LIST_TOP_DATA = "cdn2/ListTopData";
