...
// 自助解封
export const Create_UnblockIp = 'dayu2/CreateUnblockIp' // 确定解封
...
export const DESCRIBE_DDOSNETIPLOG = 'dayu2/DescribeDDoSNetIpLog' //获取高防IP专业版资源的DDoSIP攻击日志
export const DESCRIBE_DDOSATTACKSOURCE = 'dayu2/DescribeDDoSAttackSource' //获取DDoS攻击源列表