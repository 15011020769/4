...
export const MODIFYCCN_ATTRIBUTE = 'vpc2/ModifyCcnAttribute' // 修改CCN公用方法
...
export const GET_CCNREGIONBANDWIDTHLIMITS = 'vpc2/GetCcnRegionBandwidthLimits' // 查询-各地域出带宽限速

export const SET_CCNREGIONBANDWIDTHLIMITS = 'vpc2/SetCcnRegionBandwidthLimits' //修改-各地域出带宽限速

export const CCN_ROUTES = 'vpc2/DescribeCcnRoutes' // 查询-路由表

export const ENABLE_CCNROUTES = 'vpc2/EnableCcnRoutes' // 启用路由
export const DISABLE_CCNROUTES = 'vpc2/DisableCcnRoutes' // 停用路由
