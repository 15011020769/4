        ...
        <div>
          ...
          <el-form style="display:inline-block">
            <el-form-item label :required="true" class="floatLeftItem">
              ...
              <el-dialog title="配置测试模板" :visible.sync="newCreateModel" width="50%" :append-to-body="true"
          ...
          <div class="tea-form" style="display:flex">
            ...
            <div>
              <div style="display:flex">
                <el-input v-model="disinput" placeholder="还未选择文件" style="margin-right:20px" size="small" disabled>
                </el-input>
                <el-input style="padding:0;width:90px" type="file" class="btnUp" size="small" @input="inpChange">
                </el-input>
              </div>
          ...
          <div class="newClear">
            ...
            <div class="borderLeftBlue borderLeftBlue3">
              ...
              <div>
                ...
                <br />Report RequestId: 5a81551d-084b-11ea-a122-5254005dc76e Duration:0.18ms Memory:128MB
                MaxMemoryUsed:10.0938MB
              </div>
            </div>
          </div>
        </div>
