module.exports = {
  ...
  CAM: {
    ...
    userList: {
      ...
      listTitle: '用戶清單',
      listText: '如何檢視更多訊息?',
      listContext: '訪問管理對您的敏感訊息進行安全升級保護，您可以點擊清單中【詳情】列下拉按鈕【▶】檢視用戶的身份安全狀態、已加入組以及消息訂閱等更多訊息。您也可以點擊用戶名進入用戶詳細訊息中檢視或編輯。',
      listAdduser: '新增用戶',
      ...
      removeContext: '需要您注意的是， API 密鑰刪除後無法恢復，請您確認清楚再進行刪除。用戶被刪除後，該用戶無法登入台富雲以及接收消息通知，同時會解除關聯許可權。',
      myId: '密鑰ID',
      createTime: '創建時間',
      userZt: '狀態',
      removeMore: '批量刪除',
      ...
      access: '台富雲控制台訪問',
      password: '啟用密碼，允許用戶登入到台富雲控制台',
      ConsolePassword: '控制台密碼',
      generation: '自動生成密碼',
      Custom: '自定義密碼',
      passAgin: '用戶必須在下次登入時重置密碼',
      open: '啟用虛擬 MFA 設備校驗',
      doOpne: '不開啟',
