    ...
    <div class="container">
      <div class="contant">
            ...
            <div class="first_right">
              <p style="margin-bottom:30px">
                ...
                <el-radio-group v-model="radioAccount" @change="changeAccount">
                  <el-radio label="1">{{
                    $t("CAM.Role.currentMainAccount")
                  }}</el-radio>
                  <el-radio label="2">{{
                    $t("CAM.Role.otherMainAccount")
                  }}</el-radio>
                </el-radio-group>
              </p>
              <p>
        ...
        <div style="margin:20px 0px">
          <el-button size="small" v-if="active != 1" @click="reTurn">{{
            $t("CAM.Role.goBack")
          }}</el-button>
          <el-button
            type="primary"
