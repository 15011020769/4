  ...
  <div class="RoleDetail wrap">
    ...
    <div class="container">
      <div class="baseInfo">
        ...
        <div class="baseInfo_flex">
          ...
          <p v-if="roleCarrierType === 'federated'">
            ...
            <el-checkbox v-model="consoleLogin" @change="onChangeConsoleLogin"
              >允許當前角色訪問控制台</el-checkbox
            >
          </p>
          <p>
            ...
            <div class="config">
              ...
              <div class="config_table">
                ...
                >
                  ...
                  <el-table-column
                    label="條件"
                    v-if="roleCarrierType === 'federated'"
                  >
                    <template slot-scope="scope" show-overflow-tooltip>
                      <span v-if="condition[scope.$index].length">
                        ...
                        <el-button
                          type="text"
                          :disabled="roleCarrierType !== 'federated'"
                          @click="
                          ...
                          v-if="condition[scope.$index].length > 1"
                          >以及({{
                    ...
                    <template slot-scope="scope">
                      ...
                      <el-button
                        ...
                        @click.native.prevent="
                          delRolePolicy(scope.$index, roleCarrier)
                        "
                        type="text"
                        size="small"
                        >解除</el-button
                      ...
                      <el-button
                        type="text"
                        size="small"
                        v-show="roleCarrierType === 'federated'"
                        @click="
                          handleRolePayloadRelationVisible(
                            scope.row,
                            condition[scope.$index]
                ...
                >
                  <span class="pagtotal"
                    >共&nbsp;{{ TotalCounts }}&nbsp;{{ $t("CAM.strip") }}</span
                  >
                  <el-pagination
                    :page-size="pagesize"
                    :pager-count="7"
      ...
      <el-dialog
        ...
        width="25%"
        :before-close="handleCloseSessionHint"
      >
      ...
      >
        ...
        <p style="text-align:center">
          <el-button @click="Relieve_dialogVisible = false" size="small"
            >取 消</el-button
          >
          <el-button
            type="primary"
      ...
      >
        ...
        <p style="text-align:center;margin-top:30px">
          <el-button @click="dialogVisiblePolicies = false" size="small"
            >取 消</el-button
          >
      ...
      >
        ...
        <el-checkbox v-model="cancelAllSessionChecked"
          >我已知曉上述信息並確認要撤銷該角色所有會話</el-checkbox
        >
        <span slot="footer" class="dialog-footer">
          <el-button
            type="primary"
            :disabled="!cancelAllSessionChecked"
            @click="cancelAllSession"
            >確認撤銷會話</el-button
          >
          <el-button @click="dialogVisibleCancelAllSession = false"
            >取消</el-button
          >
        </span>
      </el-dialog>
      ...
      <rolePayloadRelation
        :visible.sync="rolePayloadRelationVisible"
        :relationList="currentRelationList"
        :relationPayload="currentRelationPayload"
        @saved="saveRelationList"
      />
    </div>
  </div>
</template>
