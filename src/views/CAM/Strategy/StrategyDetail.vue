        ...
        <div class="baseInfo_flex">
          ...
          <div class="baseInfo_right">
            ...
            <p class="baseInfo_mark item">
              <el-input v-if="input_show" v-model="input_Value" size="mini" style="width:150px"
      ...
      <div class="tabs">
        <el-tabs v-model="activeName" @tab-click="handleClick">
          ...
          <el-tab-pane :label="$t('CAM.strategy.straGroup')" name="first">
            <div class="config">
              <p style="margin:10px">
                <el-button type="primary" @click="Relation_user" size="small">{{$t('CAM.strategy.straGroup')}}
                </el-button>
                <el-button type="primary" @click="Relieve_user" size="small" :disabled="display">
                  {{$t('CAM.strategy.outBindUser')}}</el-button>
              </p>
              <div class="config_table">
                <el-table v-loading="loading" :data="policysData" height="300" @selection-change="handleSelectionChange"
                  :row-style="{height:0}" :cell-style="{padding:'5px 10px'}"
                  ...
                  <el-table-column prop="date" :label="$t('CAM.strategy.straGroup')">
                    <template slot-scope="scope">
                      <el-button @click="handleClickPolicies(scope.row)" type="text" size="small">{{scope.row.Name}}
                      </el-button>
                    </template>
                  </el-table-column>
                    ...
                    <template slot="header">
                      <el-dropdown trigger="click" @command="handleCommand" size="mini">
                        ...
                        <el-dropdown-menu slot="dropdown">
                          <el-dropdown-item v-for="item in table_options" :key="item.value" :command="item">
                  ...
                  <el-table-column prop="address" label="操作">
                    <template slot-scope="scope">
                      ...
                      <el-button size="mini" type="text" @click="removePolicyEntity(scope.row)" slot="reference">
                        {{$t('CAM.strategy.sureOubind')}}
                        <span v-show="scope.row.RelatedType == '2'">{{$t('CAM.strategy.team')}}</span>
                      </el-button>
                    </template>
                  </el-table-column>
                </el-table>
