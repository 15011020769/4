<template>
  <div class="Cam" id="app">
    ...
    <div class="container">
      <el-steps :space="160" :active="active" simple
      ...
      <div v-show="active==0">
        <el-form :model="addModel" :rules="rules" size="mini" ref="ruleForm" label-width="100px">
          ...
          <el-form-item label="元数据文档" prop="metadataDocument">
            <el-upload size="mini" accept="text/xml, application/xml" class="upload-demo" :limit='1'
      ...
      <div v-show="active==1">
        <template>
          <SecondStep :addModel="addModel" :name="addModel.providerName" />
        </template>
      </div>
      <br />
      <br />
      <el-button v-show="active>0" size="small" type="primary" @click="step">上一步</el-button>
      <el-button v-show="active<1" size="small" type="primary" style="margin-top: 12px;" @click="next('ruleForm')">下一步
      </el-button>
        ...
        this.$refs[formName].validate(valid => {
          if (valid) {
            ...
            const params = {
              ...
              SAMLMetadataDocument: this.addModel.metadataDocument
            };
            console.log(params);
