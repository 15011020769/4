          ...
          <!-- <div class="bodyRight" style="flex:1">
            <p>
              ...
              <span>{{userData.PhoneNum ? userData.PhoneNum : '-'}}
                <el-tooltip v-if="userData.PhoneNum && userData.PhoneFlag === 0" effect="dark" content="請儘快驗證當前消息管道，保證帳號可正常接收消息。" placement="top">
            ...
            <p>
              ...
              <span>{{userData.Email ? userData.Email : '-'}}
                <el-tooltip v-if="userData.Email && userData.EmailFlag === 0" effect="dark" content="請儘快驗證當前消息管道，保證帳號可正常接收消息。" placement="top">
