<template>
  <div class="wrap">
    ...
    <div class="operation" style="width:96%;margin: 0 auto;margin-bottom:20px;">
      ...
      <el-button type="primary" class="addUser" size="small" @click="addUser" style="margin-left:0;">
      ...
      <el-button type="primary" class="addUser" size="small" @click="deleteMoreUsers">
      ...
      <el-input :placeholder="$t('CAM.userList.searchUser')" size="small" class="inputSearch" v-model="inpVal"
        @change="userInpSearch" style="margin-right:0;">
            ...
            <template slot-scope="scope">
              <div class="form">
                <el-form label-position="left" inline class="demo-table-expand" v-model="form">
                  ...
                  <div class="detialsUser">
                    <el-form-item :label="$t('CAM.userList.userName')" class="Name">{{scope.row.Name}}</el-form-item>
                  </div>
                </el-form>
              </div>
            </template>
      ...
      <div class="container" v-if="userGroupShow">
        <div class="container-right">
          ...
          <el-table v-model="searchGroupValue" ref="multipleOption" tooltip-effect="dark" height="400"
            ...
            :data="userGroup" v-loading="loading">
            <el-input size="mini" style="width:20%" />
            <el-button size="mini" class="suo" icon="el-icon-search" show-overflow-tooltip></el-button>
            <el-table-column type="selection" width></el-table-column>
    ...
    <el-dialog title="删除用户" :visible.sync="dialogDeleteUser" width="50%" :before-close="deleteRowHandl">
