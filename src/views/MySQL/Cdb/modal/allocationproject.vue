  ...
  methods: {
    ...
    project () {
      var parms = {
        ...
        NewProjectId: this.Selection.projectId
      }
      this.axios.post('cdb2/ModifyDBInstanceProject', parms).then(data => {
