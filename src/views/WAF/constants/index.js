...
export const ATTACK_TYPE = [
  { id: "SQL注入攻击", label: "SQL注入攻擊" },
  { id: "XSS攻击", label: "XSS攻擊" },
  { id: "命令注入攻击", label: "命令注入攻擊" },
  { id: "LDAP注入攻击", label: "LDAP注入攻擊" },
  { id: "SSI注入攻击", label: "SSI注入攻擊" },
  { id: "XML注入攻击", label: "XML注入攻擊" },
  { id: "WEB服务器漏洞攻击", label: "WEB伺服器漏洞攻擊" },
  { id: "WEB应用漏洞攻击", label: "WEB應用漏洞攻擊" },
  { id: "路径跨越攻击", label: "路徑跨越攻擊" },
  { id: "核心文件非法访问", label: "核心文件非法訪問" },
  { id: "文件上传攻击", label: "文件上傳攻擊" },
  { id: "木马后门攻击", label: "木馬後門攻擊" },
  { id: "CSRF攻击", label: "CSRF攻擊" },
  { id: "恶意扫描", label: "惡意掃描" },
  { id: "自定义策略", label: "自定義策略" },
  { id: "地域封禁拦截", label: "地域封禁攔截" },
  { id: "信息防泄漏替换", label: "信息防泄漏替換" },
  { id: "AI引擎检出", label: "AI引擎檢出" },
  { id: "IP黑名单", label: "IP黑名單" },
  { id: "CC策略拦截", label: "CC策略攔截" },
  { id: "Bot 拦截", label: "Bot 攔截" },
]
