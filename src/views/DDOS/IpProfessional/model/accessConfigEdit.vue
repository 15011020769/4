        ...
        <div class="createRulesForm">
          <div class="ruleList newClear">
            ...
            <span class="ruleListIpt">
              <el-input v-model="EnidData.RuleName"></el-input><p>{{$t('DDOS.accessCopy.accessCopyTitle')}}</p>
            </span>
          </div>
          <div class="ruleList newClear">
          ...
          <div class="ruleList newClear">
            ...
            <span class="ruleListIpt">
              <el-button class="BackResouse" :style="EnidData.LbType==1?'color:#006eff;border:1px solid #006eff':''">{{$t('DDOS.accessCopy.WeightedPoll')}}</el-button>
            </span>
          </div>
