        ...
        <div class="modelCenterCon">
          ...
          <p>
            ...
            >
              ...
              <span>
                <el-select v-model="servicePack.cleanTime" class="setSelect" >
              ...
              <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="changeSureTip4()">确 定</el-button>
              </span>
            </el-dialog>
          ...
          <p>
            ...
            <span>
              ...
              <span v-if="iptNummbps"><el-input v-model="iptmbpsText" class="intMbps" @input="CreateBasic"></el-input> Mbps</span>
            </span>
          </p>
        </div>
      </el-dialog>
