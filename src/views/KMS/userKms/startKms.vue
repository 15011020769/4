<template>
  <div>
    <el-dialog class="dialogModel" :title="contentDialog[2]==$t('KMS.total.startKms')?$t('KMS.total.startKmsServer'):$t('KMS.total.stopKmsServer')" :visible.sync="disableDialog" width="50%" :before-close="handleClose">
      <div>
