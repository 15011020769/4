...
import {
  CREATE_LIVE_CERT,
  MODIFY_LIVE_DOMAIN_CERT,
  MODIFY_LIVE_CERT,
  BIND_LIVE_DOMAIN_CERT
} from "@/constants";
const error = {
  InternalError: "內部錯誤",
...
export default {
  ...
  watch: {
    cert: function(newValue, oldValue) {
      this.form = {
        ...newValue,
        enable: (newValue && !!newValue.Status) || false
      };
    }
  },
  methods: {
