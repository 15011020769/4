    ...
    <el-col :span="12">
        <div class="basicinfo" v-loading="loading1">
          <el-row type="flex" justify="space-between">
            <h1 class="">HTTPS配置 
              <el-tooltip class="item" effect="dark" content="HTTPS功能配置完成后约2小时生效，请耐心等待。" placement="right">
    ...
    <el-col :span="12">
      ...
      <el-card> -->
        <div class="basicinfo" v-loading="loading4">
          <el-row type="flex" justify="space-between">
            <h1 class="">源站设置
              <el-tooltip class="item" effect="dark" content="源站设置功能配置完成后约1天生效，请耐心等待。" placement="bottom">
                <i class="el-icon-info" />
              </el-tooltip>
            </h1>
          ...
          <div class="bgGray">
            ...
            <div class="newClear newList1">
              <p>主源地址</p>
              <p>{{resource.SourceServerAddress && resource.SourceServerAddress[0] || '暂无'}}</p>
            </div>
          </div>
        </div>
      <!-- </el-card> -->
      ...
      <el-dialog
        ...
        width="800px"
      >
        <band-limit :playType="domainInfo.PlayType" :bandLimit="bandLimit" @success="getBandLimit" :visible="visibleBandLimit" />
      </el-dialog>
    </el-col>
  </el-row>
</template>
