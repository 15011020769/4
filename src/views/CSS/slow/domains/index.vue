  ...
  <div class="domainManagement-wrap">
    ...
    <div class="wrap">
      <div class="domainTitle-wrap">
        <div class="title">
          <p>關於推流域名：慢直播已為您提供系統推流域名，您亦可添加自有已備案域名進行推流</p>
        </div>
        <div class="title">
          <p>
            關於播放域名：您需要添加自有已備案域名進行慢直播播放，更多域名管理使用方法參見
            <el-link
              type="primary"
      ...
      <addModel :isShow="addModel" :isDelayLive="1" @closeAddModel="closeAddModel" />
      <stopModel
        :isShow="stopModel"
        :con="DomainName"
...
import addModel from '../../domainManagement/model/addModel'
import stopModel from '../../domainManagement/model/stopModel'
import deleteModel from '../../domainManagement/model/deleteModel'
import { DOMAIN_LIST, ENABLE_DOMAIN, PROHIBIT_DOMAIN } from '@/constants'
import { isOwnDomain } from '../../domainManagement/utils/OwnDomain'
