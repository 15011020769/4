    ...
    <div class="cutoutTable">
      <div class="tableWrap">
        <el-table :data="tableData" v-loading="loading">
          <el-table-column prop="StreamName" :label="$t('CSS.cutout.3')"></el-table-column>
          <el-table-column prop="AppName" :label="$t('CSS.cutout.4')"></el-table-column>
          <el-table-column prop="DomainName" label="域名"></el-table-column>
          <el-table-column prop="StreamStartTime" :label="$t('CSS.cutout.5')">
            <template slot-scope="scope">{{format(scope.row.StreamStartTime)}}</template>
          </el-table-column>
          ...
          <el-table-column prop="ClientIp" label="推流客户端IP"></el-table-column>
          <el-table-column prop="StopReason" :label="$t('CSS.cutout.8')"></el-table-column>
        </el-table>
      </div>
