...
<template>
  <div>
    ...
    <div class="tke-card mt10">
      ...
      >
        ...
        <el-table-column label="操作" width="240">
          <template slot-scope="scope">
            <span class="tke-text-link" @click="goPodUpdate(scope.row)">{{$t('TKE.subList.gxsl')}}</span>
             <el-tooltip  v-if="nameSpaceName=='kube-system'"   class="item" effect="light" :content="$t('TKE.subList.dqbkcz')" placement="right">
                   <el-button
                    type="text"
                    class="notuse ml10"
                    >更新Pod配置</el-button>
            ...
            <el-dropdown class="tke-dropdown"  trigger="click">
              ...
              <el-dropdown-menu slot="dropdown" >
                <el-dropdown-item command="a">
                  <span class="tke-text-link" @click="redeployment(scope.row)">{{$t('TKE.subList.cxbs')}}</span>
                </el-dropdown-item>
                <el-dropdown-item command="a">
                  <el-tooltip  v-if="nameSpaceName=='kube-system'"   class="item" effect="light" :content="$t('TKE.subList.dqbkcz')" placement="right">
                   <el-button
                  ...
                  <span v-else class="tke-text-link" @click="goSetUpdateTactics(scope.row)">{{$t('TKE.subList.szgxcl')}}</span>
                </el-dropdown-item>
                ...
                <el-dropdown-item command="c">
                   <el-tooltip  v-if="nameSpaceName=='kube-system'"   class="item" effect="light" :content="$t('TKE.subList.dqbkbj')" placement="right">
                   <el-button
                    type="text"
                    class="notuse"
    ...
    <el-dialog :title="$t('TKE.subList.cxbs')" :visible.sync="isShowRedeployment" width="35%">
      <p style="font-weight: bolder;color: #444;">{{$t('TKE.subList.qdcxbs')}}Deployment：{{deploymentName}}嗎？</p>
      <p>{{$t('TKE.subList.cxbsjx')}}</p>
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitRedeployment()">{{$t('TKE.overview.qd')}}</el-button>
