    ...
    <el-card class="box-card">
      ...
      <el-form class="tke-form">
        <el-form-item label="工作负载选项">
           <el-tooltip class="item" effect="light" content="工作负载类型、命名空间、Workload实例" placement="right">
              ...
              <el-select v-model="value2" placeholder="请选择" size="mini" class="ml10" >
               ...
               <el-select v-model="value3" placeholder="请选择" size="mini" class="ml10" :disabled='value2==1?true:false'>
                <el-option
