  ...
  <div >
      ...
      <div class="tke-action">
        <div class="tke-grid ">
          <!-- 左侧 -->
          <div class="grid-left">
            <el-button size="small" type="primary">新建节点</el-button>
            ...
            <template slot-scope="scope">
              ...
              <el-dropdown class=" tke-dropdown" >
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item command="a"><span class="tke-text-link">封锁</span></el-dropdown-item>
                  <el-dropdown-item command="a"><span class="tke-text-link">取消封锁</span></el-dropdown-item>
                  <el-dropdown-item command="b"><span class="tke-text-link" >驱逐</span></el-dropdown-item>
                  <el-dropdown-item command="c"><span class="tke-text-link">编辑标签</span></el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
            </template>
          </el-table-column>
