            ...
            <div style="margin-left: 120px">
              <div v-for="(v,i) in wl.instanceContent" :key="i">
                ...
                <SelectMirrorImg :dialogVisible.sync='SelectMirrorImgFlag' @confirm='confirmMirrorImg($event, i)'
                  @getMirrorImgTag="describeImagePersonal($event, i)" @getMirrorImgHubTag="describeDockerHubImagePersonal($event, i)"></SelectMirrorImg>
              </div>
...
import {
  ...
  TKE_DESCRIBEIMAGECONFIGPERSONAL,
  TKE_DESCRIBEDOCKERHUBIMAGEPERSONAL
} from '@/constants'
