  ...
  <div class="colony-main">
    <div class="tke-card tke-formpanel-wrap">
      ...
      <el-form  class="tke-form" label-position='left' label-width="120px" size="mini">
        ...
        <el-form-item label="更新策略">
          <div class="tke-form-item_text">{{rowData.spec && rowData.spec.strategy && rowData.spec.strategy.type || '-'}}</div>
        </el-form-item>
        <el-form-item label="副本数">
          <div class="tke-form-item_text">{{rowData.spec && rowData.spec.replicas || '-'}}</div>
        </el-form-item>
        <el-form-item label="运行副本数">
          <div class="tke-form-item_text">{{rowData.status && rowData.status.readyReplicas || 0}}</div>
        </el-form-item>
    ...
    <div class="tke-card tke-formpanel-wrap mt10">
      ...
      <el-tabs v-model="activeName" @tab-click="handleClick" class="tab-background">
        ...
        <el-tab-pane label="" name="k8s_node" class="tab-one"></el-tab-pane>
      </el-tabs>
    </div>
   </div>
</template>
