     ...
     <div class="tke-content-header">
       <div class="tke-grid ">
         ...
         <div class="grid-left">
           ...
           <h2 class="header-title" v-if='type=="number"'>更新Pod数量</h2>
           <h2 class="header-title" v-if='type=="config"'>更新Pod配置</h2>
         </div>
         <!-- 右侧 -->
           ...
           <el-form-item label="实例数量">
             ...
             <div v-if="upn.type=='2'">
               ...
               <el-form-item label="触发策略" style="margin-top:10px">
                 <div class="bottom10" v-for="(item,index) in touchTactics" :key="index">
                   <el-select class="w100" v-model="item.touch1">
                     <el-option v-for="item in  touchOptions1" :key="item.value" :label="item.label"
                       :value="item.value">
                     </el-option>
                   </el-select>
                   <el-select class="margin-middle" v-model="item.touch2">
