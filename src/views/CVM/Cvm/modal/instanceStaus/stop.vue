<template>
  <div class="close">
    <el-dialog :visible.sync="stopStatus.stopDialog" :show-close="false" width="40%">
      ...
      <div class="content">
        ...
        <div :class="[basic?'table':'']">
          ...
          >
            ...
            <el-table-column label="实例ID" width="150">
              <template slot-scope="scope">
              <div>
...
export default {
  ...
  mounted() {
    this.instanceInfo = this.stopStatus.InstanceItem;
  },
  methods: {
    ...
    handleCancel(value) {
      if (value) {
        ...
        this.axios.post("cvm2/StopInstances", params).then(data => {
          if(data.Response) {
