<template>
  <div class="renew">
    <el-dialog :visible.sync="editObj.editShow" :show-close="false" width="55%">
...
export default {
  data () {
    return {
      basic: true,
      form: {
        name: this.editObj.shotInfo.SnapshotName
      },
      rules: {
        name: [
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          var params = {
            ...
            'SnapshotId': this.editObj.shotInfo.SnapshotId,
            'SnapshotName': this.form.name
          }
          this.axios
            .post('cbs2/ModifySnapshotAttribute', params)
            .then(data => {
