  ...
  <div class="tabOne">
    ...
    <el-dialog :title="$t('CCN.tabs.tab1')" :visible.sync="newVisible" class="newDialog">
            ...
            <div class="tr-con" v-for="(item, index) in formArr" :key="index">
              <td>
                <el-select
                  ...
                  :placeholder="$t('CCN.tabs.tab1new2')"
                  @change="_instance()"
                >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="attCcnIns(form)">{{$t('CCN.total.buttomTJ')}}</el-button>
    ...
    <el-dialog :title="$t('CCN.tabs.tab1del')" :visible.sync="dialogVisible" width="40%">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="dialogVisible = false">{{$t('CCN.total.buttonQX')}}</el-button>
      </span>
    </el-dialog>
  </div>
</template>
