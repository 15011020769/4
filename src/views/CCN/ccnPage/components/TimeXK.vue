  ...
  <div>
    <div class="box-dis">
      ...
      <div class="btn-style">
          ...
          <el-button-group>
            ...
            <el-popover placement="bottom" width="400" trigger="manual" v-model="visible">
              ...
              <el-row class="margin-row">
                <el-button size="mini" type="primary" @click="Sure">{{$t('CCN.total.sure')}}</el-button>
                <el-button size="mini" @click="visible = false">{{$t('CCN.total.buttonQX')}}</el-button>
              </el-row>
              <el-button
                size="small"
                v-if="datetim"
                ...
                @click="SelectionTime"
                slot="reference"
              >{{$t('CCN.timeX.placeholder1')}}</el-button>
            </el-popover>
            <el-date-picker
              v-if="datetime"
              v-model="datetimeval"
              type="datetimerange"
              :range-separator="$t('CCN.timeX.tos')"
              :start-placeholder="$t('CCN.timeX.startTime')"
              :end-placeholder="$t('CCN.timeX.endTime')"
              :clearable="false"
              class="dateheight"
              @change="ReSelection"
            ></el-date-picker>
        ...
        <div class="drop">
          <span style="margin-right:15px">{{$t('CCN.timeX.timeLD')}}:</span>
          <el-select
            v-model="value"
            :placeholder="$t('CCN.tabs.tab1new4')"
            @change="switchData()"
            size="small"
          >
            <el-option
