<template>
  <div class="Deal">
    <div class="top">
      ...
      <el-select v-model="dataForm.projectId" :placeholder="$t('BILL.Detail.allProject')" @change="getProjectListInfo()"
        clearable size="small" style="padding-left: 25px;">
        <el-option v-for="item in getprojectList" :key="item.projectId" :label="item.projectName"
    ...
    <div class="deal-content">
      <div class="deal-form">
        <el-form :inline="true" :model="dataForm" class="demo-form-inline" @keyup.enter.native="getDataList()">
          <el-form-item>
            <el-input :placeholder="$t('BILL.Deal.orderId')" clearable v-model="dataForm.orderId">
      ...
      <div class="deal-box">
        <el-table :data="dataList" class="table-content" v-loading="dataListLoading">
          <el-table-column prop="orderId" header-align="center" align="center" width="150"
            :label="$t('BILL.Deal.orderId')">
          </el-table-column>
          <el-table-column prop="status" header-align="center" align="center" width="120"
            :label="$t('BILL.Deal.status')" :formatter="formatterStatus">
          </el-table-column>
          <el-table-column prop="projectId" header-align="center" align="center" width="120"
            :label="$t('BILL.Deal.projectId')">
          </el-table-column>
          <el-table-column prop="goodsCategoryId" header-align="center" align="center" width="120"
            :label="$t('BILL.Deal.goodsCategoryId')">
          </el-table-column>
          <el-table-column prop="realTotalCost" header-align="center" align="center" width="150"
            :label="$t('BILL.Deal.realTotalCost')">
          </el-table-column>
          <el-table-column prop="voucherDecline" header-align="center" align="center" width="150"
            :label="$t('BILL.Deal.voucherDecline')">
          </el-table-column>
          <el-table-column prop="policy" header-align="center" align="center" width="120"
            :label="$t('BILL.Deal.policy')">
          </el-table-column>
          <el-table-column prop="price" header-align="center" align="center" width="120" :label="$t('BILL.Deal.price')">
          </el-table-column>
          <el-table-column prop="totalCost" header-align="center" align="center" width="120"
            :label="$t('BILL.Deal.totalCost')">
          </el-table-column>
          <el-table-column prop="usdCost" header-align="center" align="center" width="120"
            :label="$t('BILL.Deal.usdCost')">
          </el-table-column>
          <el-table-column prop="ntCost" header-align="center" align="center" width="120"
            :label="$t('BILL.Deal.ntCost')">
          </el-table-column>
          ...
          <el-table-column prop="createTime" header-align="center" align="center" width="160"
            :label="$t('BILL.Deal.createTime')">
          </el-table-column>
          <el-table-column fixed="right" header-align="center" align="center" width="180" label="操作">
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="detailHandle(scope.row)">{{$t('BILL.Deal.details')}}
              </el-button>
            </template>
          </el-table-column>
        </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      download() {
        ...
        this.axios.post(`${process.env.VUE_APP_adminUrl}taifucloud/torderproduct/exportList`, params, {
          responseType: 'blob'
        }).then(res => {
          const content = res
