  ...
  <div class="Deal">
    ...
    <div class="top">
      ...
      <el-select
        ...
        :placeholder="$t('BILL.Detail.allProject')"
        @change="getProjectListInfo()"
        clearable
        size="small"
      ...
      <div class="deal-form">
        ...
        >
          ...
          <el-form-item class="item-2">
            <el-input
              :placeholder="$t('BILL.Deal.orderId')"
              size="small"
              clearable
