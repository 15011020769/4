<template>
  <el-dialog :title="$t('BILL.Deal.details')" :close-on-click-modal="false" :visible.sync="visible">
    <el-form :model="dataForm" ref="dataForm" label-width="160px">
      <el-form-item :label="$t('BILL.Deal.orderId')" prop="orderId">
        <el-input v-model="dataForm.orderId" :disabled="true" style="width: 400px;"></el-input>
      </el-form-item>
      <el-form-item :label="$t('BILL.Deal.productDetail')" prop="productInfo">
        <el-input type="textarea" :rows="8" v-model="dataForm.productInfo" :disabled="true" style="width: 400px;">
        </el-input>
      </el-form-item>
    </el-form>
