                ...
                <template slot-scope="scope">
                  <div slot="reference">
                    <el-popover placement="left" width="700" ref="popover" trigger="hover">
                      ...
                      <div name="tableLine1" :id="'tableLine1-'+scope.row.business_code_name" style="height: 250px; width:650px"></div>
                    </el-popover>
                  </div>
                </template>
              </el-table-column>
    ...
    initLine1() {
      this.dataList1.forEach((row, index) => {
        ...
        this.axios.post(`${process.env.VUE_APP_adminUrl + GET_LINE_LIST}`, params).then(data => {
          ...
          this.charLine1 = echarts.init(document.getElementById('tableLine1-' + productName))
