<template>
  <div class="wrap">
    <el-dialog :visible.sync="newBuildShow.newBuildState" width="1024px" :show-close="false" class="dialog-box">
      <div class="title">
        <h3>新建</h3>
      ...
      <div class="dialog">
        <div class="p">
          <span>分组名</span>
          <el-tooltip :disabled="groupingNameTips" placement="bottom" effect="light">
            <div slot="content" class="group-name">
              <i class="el-icon-info ml5"></i>
              {{ nameTips }}
            </div>
            <el-input v-model="groupingName" placeholder="1-20个中英文字符或下划线" class="group-input" @input="GroupingNameInput"
        ...
        <div class="p">
          ...
          <product-type-cpt v-on:PassData="passData" :searchParam="searchParam" :projectId="projectId"
            :productValue="productValue" v-on:loading="Type_loading" />
        </div>
        <div class="p">
          <span>添加至组</span>
