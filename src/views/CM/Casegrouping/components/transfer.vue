      ...
      <div class="left">
        <div class="left-main border">
          <div class="seek" style="">
            <el-input v-model="input" placeholder="请输入内容" @change="_inpVal" style=""></el-input>
            <p>
          ...
          >
            ...
            <el-table-column prop="Type" label="网络类型" width="120"></el-table-column>
            <el-table-column prop="PolicyName" label="IP地址" width="120"></el-table-column>
          </el-table>
        </div>
      </div>
      <div class="mid">
      ...
      <div class="right">
        <div class="right-main border">
          <el-table :data="multipleSelection" style="" height="450">
            ...
            <el-table-column prop="PolicyName" label="IP地址" width="150"></el-table-column>
          </el-table>
        </div>
      </div>
    </div>
