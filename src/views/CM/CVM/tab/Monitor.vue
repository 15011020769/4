    ...
    data() {
      return {
        ...
        Tips: {
          ...
          'BaseCpuUsage': ' 基礎CPU使用率通過宿主機收集上報，無須安裝監控元件即可檢視數據，子機高負載情況下仍可持續收集上報數據',
          'CpuLoadavg': '1分鐘內CPU平均負載，取 /proc/loadavg 第一列數據（windows作業系統無此指標），依賴監控元件安裝收集',
          'CpuUsage': 'CPU利用率是通過CVM子機內部監控元件收集上報，數據更加精準',
          ...
          'MemUsed': ' 使用的記憶體量，不包括系統快取和快取區佔用記憶體，依賴監控元件安裝收集',
          'TcpCurrEstab': '處於 ESTABLISHED 狀態的 TCP 連接數量，依賴監控元件安裝收集',
          'WanInpkg': '外網平均每秒入包量',
