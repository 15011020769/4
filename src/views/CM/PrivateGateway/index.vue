      ...
      <el-table :data="ProTableData" height="550" style="width: 100%" v-loading="loadShow"
        ...
        <el-table-column prop :label="$t('CVM.cloudDisk.mc')">
          <template slot-scope="scope">
            <p>
              <a @click="jump(scope.row.DirectConnectGatewayId)"
                style="cursor:pointer;">{{scope.row.DirectConnectGatewayId}}</a>
            </p>
        ...
        <el-table-column prop :label="$t('CVM.clBload.jk')">
          <template slot-scope="scope">
            ...
            <el-button type="text" class="iconfont icon-tubiaozhanshi" style="color: #888;"
              @click="jump(scope.row.DirectConnectGatewayId)"></el-button>
          </template>
        </el-table-column>
        <el-table-column prop :label="$t('CVM.clBload.sswl')">
          <template slot-scope="scope">
            <a :href="'../VPC/index.html#/priNetwork/priNetworkDetial/'+ scope.row.VpcId + '/ap-taipei'" target="_self">
              {{scope.row.VpcId}}</a>
          </template>
        </el-table-column>
