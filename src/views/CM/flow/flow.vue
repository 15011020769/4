            ...
            <div class="box">
              <div class="table-top">
                <div class="table_top_head">
                  <div style>
                    <TimeDropDown :TimeArr="TimeArr" :Datecontrol="true" :Graincontrol="false" v-on:switchData="GetDate"
                      :Difference="'D'"></TimeDropDown>
                  </div>
                  <!-- <div class="contrast">
              ...
              <div class="table">
                <el-table :data="tableData" style="width: 100%" height="450"
                  :default-sort="{prop: 'date', order: 'descending'}" v-loading="loadShow" id="exportTable">
                ...
                <div class="Right-style pagstyle">
                  ...
                  <el-pagination :page-size="pagesize" :pager-count="7" layout="sizes,prev, pager, next"
                    @current-change="handleCurrentChange" @size-change="handleSizeChange"
                    :page-sizes="[10, 20, 50, 100]" :total="TotalCount"></el-pagination>
                </div>
              </div>
            </div>
          </div>
      ...
      GetMonitor() {
        ...
        this.axios.post(All_MONITOR, param).then(res => {
          if (res.Response.Error == undefined) {
            ...
            // 分页处理
            for (
              let j = (this.currpage - 1) * this.pagesize; j < table.length; j++
            ) {
