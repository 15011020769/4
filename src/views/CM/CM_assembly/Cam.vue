<template>
  <div class="qudaoContent">
    ...
    <div>
      <el-table :data="tableData2" style="width: 100%" height="430"
        ...
        <el-table-column label="用户名">
          <template slot-scope="scope">
            <span v-for="(item,index) in scope.row.UserInfo">{{item.Name}}</span>
          </template>
        </el-table-column>
      </el-table>
    </div>
    ...
    <p class="effective-period">
      <span>有效时段&nbsp;&nbsp;</span>
      <el-time-picker style="width:150px" v-model="value1" :picker-options="{selectableRange: '18:30:00 - 20:30:00'}"
        placeholder="任意时间点">
      </el-time-picker>
      <span>&nbsp;至&nbsp;</span>
      <el-time-picker style="width:150px" arrow-control v-model="value2"
        :picker-options="{selectableRange: '18:30:00 - 20:30:00'}" placeholder="任意时间点">
      </el-time-picker>
    </p>
