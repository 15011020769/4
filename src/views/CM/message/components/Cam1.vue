  ...
  <div class="qudaoContent">
    ...
    <div>
      ...
      <el-table v-if="formInline.jieshou === '0'" :data="tableData2" v-loading="loadingShow"
        @selection-change="handleSelectionChange" ref="multipleTable" style="width: 96%;margin-left:60px;" height="430"
        ...
        <el-table-column label="用戶名">
          <template slot-scope="scope">
            <span v-if="scope.row.UserInfo.length !== 0" v-for="(item,index) in scope.row.UserInfo" :key="index">
              <span>{{item.Name}}</span>
