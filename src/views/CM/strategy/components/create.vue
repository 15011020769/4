      ...
      <div class="box">
        <el-form class="create-form" :model="formInline" ref="form" label-position="left" label-width="70px"
          ...
          <el-form-item label="策略名稱" prop="strategy_name" :rules="strategyNameValidator">
            <el-input class="w200" v-model="formInline.strategy_name" placeholder="1-20個中英文字符或下劃線" @input="EditTips" maxlength="20"></el-input>
          </el-form-item>
          ...
          <el-form-item label="告警物件">
            ...
            <p><el-radio v-model="radio" label="3">選擇實例組</el-radio>
              <el-button type="text" size="mini" style="position: relative;margin-left: 20px" @click="$router.push({ path: '/Casegrouping' })">新建實例組</el-button></p>
          </el-form-item>
          <!-- 告警對象-》選擇部分對象 -->
              ...
              <div style="background-color: #f2f2f2;padding: 20px">
                ...
                <div v-show="radioChufa === '1'" style="padding: 10px">
                  <el-form-item label-width="0px" style="margin-bottom: 0px">
                    <el-select v-model="formInline.conditionsTemplateId" style="width:150px;" placeholder="當前策略下沒有觸發條件範本" @change="conditionTemplateChange" :disabled="!formInline.conditionsTemplateId">
                    ...
                    <div style="padding-left: 21px">
                      ...
                      <div v-for="cItem in formInline.triggerCondition.Conditions" :key="cItem.RuleID">
                        <div class="indication-alarm">
                          ...
                          <el-form-item label-width="0px" style="display: inline-block">
                            <el-input style="vertical-align: baseline;width: 140px" placeholder="指標" value="0" min="0" max="100" type="number" v-model="cItem.CalcValue" disabled>
          ...
          <div style="margin-bottom: 18px">
            ...
            <div style="margin-left: 70px;background-color: #f2f2f2;">
              <Cam v-loading="receivingObjectLoad" @camClick="camFun" ref="cam" :selectedList="receivingObjectData" :type="ReceiverInfos.ReceiverType"></Cam>
            </div>
          </div>
          <!-- 接口回調 -->
          <div style="margin-bottom: 18px">
