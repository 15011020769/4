      ...
      <div class="box">
        <el-form class="create-form" :model="formInline" ref="form" label-position="left" label-width="70px"
          ...
          <el-form-item label="告警物件">
            ...
            <p>
              ...
              <el-button
                ...
                @click="$router.push({ path: '/Casegrouping' })"
              >新建實例組
              </el-button
              >
            </p>
          ...
          <div style="margin-bottom: 18px" v-show="radio === '3'">
            <div style="margin-left: 70px">
              <el-form-item label-width="0px">
                <el-select
                  v-model="formInline.instanceGroupId"
                  style="width:150px;"
                >
                  <el-option
                    v-for="(item, index) in formInline.instanceGroup"
                    :key="index"
                ...
                <el-button
                  ...
                  size="mini"
                  style="width: 50px"
                  @click="describeInstanceGroupList"
                >重新整理
                </el-button
                >
              </el-form-item>
          ...
          <div style="margin-bottom: 18px">
            <label
              style="width: 70px;vertical-align: middle;float: left;padding: 0 12px 0 0;line-height: 28px"
            >觸發條件</label
            >
            <div style="margin-left: 70px" v-loading="loading">
              ...
              <div style="background-color: #f2f2f2;padding: 20px">
                ...
                <div v-show="radioChufa === '1'" style="padding: 10px">
                  <el-form-item label-width="0px" style="margin-bottom: 0px">
                    <el-select
                      v-model="formInline.conditionsTemplateId"
                      style="width:150px;"
                      placeholder="當前策略下沒有觸發條件範本"
                      @change="conditionTemplateChange"
                      :disabled="!formInline.conditionsTemplateId"
                    >
                      <el-option
                        v-for="(item, index) in formInline.conditionsTemplate"
                        :key="index"
                        :label="item.GroupName"
                        :value="item.GroupID"
                        label-width="40px"
                    ...
                    <el-button
                      ...
                      size="mini"
                      style="margin-left: 20px"
                      @click="describeConditionsTemplateList"
                    >重新整理
                    </el-button
                    >
                  </el-form-item>
                  <div v-show="formInline.conditionsTemplateId">
                    <p
                      ...
                      v-if="formInline.triggerCondition.Conditions.length > 0"
                    >
                    ...
                    >
                      <el-form-item label-width="0px">
                        <span>滿足</span>
                        <el-select
                          v-model="formInline.triggerCondition.IsUnionRule"
                      ...
                      <div
                        v-for="cItem in formInline.triggerCondition.Conditions"
                        :key="cItem.RuleID"
                      >
                        <div class="indication-alarm">
                          ...
                          >
                            <el-input
                              style="vertical-align: baseline;width: 140px"
                              placeholder="指標"
                              value="0"
                              min="0"
                              max="100"
                              type="number"
                              v-model="cItem.CalcValue"
                              disabled
                            >
                          ...
                          <template
                            v-if="formInline.triggerCondition.IsUnionRule === 0"
                          >
                            <span>then</span>
                            <el-form-item
                              label-width="0px"
                            ...
                            >
                              <el-select
                                v-model="cItem.AlarmNotifyPeriod"
                                style="width:150px;"
                                disabled
                              >
                                <el-option
                      ...
                      <div
                        v-show="formInline.triggerCondition.IsUnionRule === 1"
                      >
                        <span>then</span>
                        <el-form-item
                          label-width="0px"
                    ...
                    >
                      <div
                        v-for="(feItem, feIndex) in formInline.triggerCondition
                          .EventConditions"
                        :key="feIndex"
                      >
                        <el-form-item label-width="0px">
                          <el-select
                            v-model="feItem.EventID"
                            style="width:180px;"
                            disabled
                          >
                            <el-option
                              v-for="(item, index) in product.EventMetrics"
                              :key="index"
              ...
              <!-- 配置觸發條件 -->
              <div
                style="background-color: #f2f2f2;padding: 20px;margin-top: 10px;"
              >
                ...
                <div v-show="radioChufa === '2'" style="padding: 10px">
                  <div
                    v-if="formInline.alarmCheckbok.length === 0"
                  ...
                  <p style="line-height: 28px">
                    <el-checkbox
                      v-model="formInline.alarmCheckbok"
                      label="指標告警"
                    >指標告警
                    </el-checkbox
                    >
                  ...
                  <div style="padding-left: 21px">
                    <el-form-item label-width="0px">
                      <span>滿足</span>
                      <el-select
                        v-model="formInline.configTrigger.IsUnionRule"
                        style="margin: 0px 5px"
                        :disabled="
                    ...
                    <div
                      v-for="(cItem, cIndex) in formInline.configTrigger
                        .Conditions"
                      :key="cItem.key"
                    >
                      <div class="indication-alarm">
                        ...
                        <el-form-item label-width="0px" style="display: inline-block" :prop="`configTrigger.Conditions.${cIndex}.CalcValue`"
                                      :rules="configTriggerCalcValueValidator">
                          <el-input style="vertical-align: baseline;width: 190px" placeholder="指標" value="0"
                                    type="number" v-model.number="cItem.CalcValue" :disabled="!formInline.alarmCheckbok.includes('指標告警')">
                        ...
                        <template
                          v-if="formInline.configTrigger.IsUnionRule === 0"
                        >
                          <span>then</span>
                          <el-form-item
                            label-width="0px"
                    ...
                    <div v-show="formInline.configTrigger.IsUnionRule === 1">
                      ...
                      >
                        <el-select
                          v-model="formInline.configTrigger.AlarmNotifyPeriod"
                          style="width:150px;"
                          :disabled="
                            !formInline.alarmCheckbok.includes('指標告警')
                          "
                    ...
                    <el-button
                      type="text"
                      size="mini"
                      @click="configTriggerAddConditions"
                    >添加
                    </el-button
                    >
                  </div>
                  ...
                  <p
                    style="line-height: 28px"
                    v-if="product.EventMetrics !== undefined"
                  >
                    <el-checkbox
                      v-model="formInline.alarmCheckbok"
                      label="事件告警"
                  ...
                  >
                    <div
                      v-for="(feItem, feIndex) in formInline.configTrigger
                        .EventConditions"
                      :key="feIndex"
                    >
                      <el-form-item
                    ...
                    <el-button
                      type="text"
                      size="mini"
                      @click="configTriggerAddEventConditions"
                    >添加
                    </el-button
                    >
                  </div>
          ...
          <div style="margin-bottom: 18px">
            <div style="width: 70px;">
              <label
                style="vertical-align: middle;float: left;padding: 0 12px 0 0;line-height: 28px"
              >接口回調</label
              >
              <!--<p>（選填）</p>-->
            </div>
            <div style="margin-left: 70px">
              <el-form-item style="display: inline-block" label-width="0px">
                <el-select
                  v-model="formInline.protocolValue"
                  style="display: inline-block"
                  @change="formInline.callbackVerifyCode = ''"
                >
                  <el-option
              ...
              >
                <el-select
                  filterable
                  v-model="formInline.callbackVerifyCode"
                  style="width: 300px"
                >
                  <el-option
                    v-for="item in formInline.protocolValue === 'http'
                      ? httpOption
                      : httpsOption"
                    :key="item.VerifyCode"
                    :label="item.website"
              ...
              >
                <p>
                  回調域名通過驗證後生效，請于Response Body中返回以下code。<i
                  class="el-icon-info"
                  style="margin:0 5px;color: #c07400;"
                ></i>
                </p>
                <p style="margin: 10px 0;font-size: 16px;font-weight: 700;">
                  {{ formInline.callbackVerifyCode === '' ? httpCodes : formInline.callbackVerifyCode }}
                </p>
              </div>
            </div>
          </div>
      ...
      configTriggerCalcValueValidator: [
        {
          validator: (rule, value, callback) => {
            if (this.radioChufa === '2') {
              ...
              let { CalcValue, MetricId } = Conditions[index]
              for (let i = 0; i < index; i++) {
              ...
              let panduanObj = this.product.Metrics.find(item => item.MetricId === MetricId)
              if (panduanObj.ConfigManual.CalcValue.Need) {
                if (parseFloat(CalcValue) > parseInt(panduanObj.ConfigManual.CalcValue.Max)) {
                  callback(new Error(`請輸入不大於${parseInt(panduanObj.ConfigManual.CalcValue.Max)}的數字`))
                  return
                }
                if (parseFloat(CalcValue) < parseInt(panduanObj.ConfigManual.CalcValue.Min)) {
                  callback(new Error(`請輸入不小於${parseInt(panduanObj.ConfigManual.CalcValue.Min)}的數字`))
                  return
                }
              }
            }
  ...
  methods: {
    ...
    saveSubmit: async function () {
      ...
      let params = {
        ...
        ProjectId:
          productValue === 'cvm_device' || productValue === 'BS'
    ...
    modifyAlarmCallback: async function () {
      let {
        formInline: { protocolValue, callbackVerifyCode },
        httpOption,
        httpsOption,
        saveResponseGroupId
      } = this
