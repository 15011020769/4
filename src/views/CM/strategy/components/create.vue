      ...
      <div class="box">
        ...
        >
          ...
          <el-form-item label="策略类型">
            <grouping-type
              @handleChangeChild="showMsgfromChild"
            ></grouping-type>
          </el-form-item>
          ...
          <div style="margin-bottom: 18px" v-show="radio === '3'">
            <div style="margin-left: 70px">
              <el-form-item label-width="0px">
                <el-select
                  v-model="formInline.instanceGroupName"
                  style="width:150px;"
                >
                  <el-option
                ...
                <el-button type="text" size="mini" style="width: 50px"
                  >刷新</el-button
                >
              </el-form-item>
            </div>
              ...
              <div style="background-color: #f2f2f2;padding: 20px">
                ...
                <div v-show="radioChufa === '1'" style="padding: 10px">
                  <el-form-item label-width="0px" style="margin-bottom: 0px">
                    <el-select
                      v-model="formInline.conditionsTemplateName"
                      style="width:150px;"
                    >
                      <el-option
          ...
          <div style="margin-bottom: 18px">
            ...
            <div style="margin-left: 70px">
              ...
              <div>
                <p>
                  回调域名通过验证后生效，请于Response Body中返回以下code。<i
                    class="el-icon-info"
      ...
      this.axios.get(ALL_PROJECT).then(res => {
        this.axiosUtils(res, () => {
          ...
          if (res.data.length > 0)
            this.formInline.projectId = res.data[0].projectId;
        });
      });
    },
      ...
      await this.axios.post(CM_GROUPING_LIST, params).then(res => {
        this.axiosUtils(res, () => {
          ...
          if (res.Response.InstanceGroupList.length > 0)
            this.formInline.instanceGroupName =
              res.Response.InstanceGroupList[0].GroupName;
        });
      });
    },
        ...
        this.axiosUtils(res, () => {
          ...
          if (res.Response.TemplateGroupList.length > 0)
            this.formInline.conditionsTemplateName =
              res.Response.TemplateGroupList[0].GroupName;
        });
      });
    },
    // 策略类型
