        ...
        >
          ...
          <el-form-item label="策略類型">
            <product-type
              ...
              :projectId="formInline.projectId"
              :productValue="formInline.productValue"
              @loading="e => (loading = e)"
            />
          </el-form-item>
          <el-form-item
          ...
          <el-form-item label="告警物件">
            <p><el-radio v-model="radio" label="1">全部物件</el-radio></p>
            <p><el-radio v-model="radio" label="2">選擇部分物件</el-radio></p>
            <p>
                      ...
                      <div class="indication-alarm">
                        ...
                        >
                          <el-input
                            ...
                            max="100"
                            type="number"
                            v-model.number="cItem.CalcValue"
                            :disabled="
                              !formInline.alarmCheckbok.includes('指標告警')
                            "
                          >
