                      ...
                      <div class="indication-alarm">
                        ...
                        <el-form-item label-width="0px" style="display: inline-block"
                          ...
                          <el-input style="vertical-align: baseline;width: 190px" placeholder="指標" value="0"
                            type="number" v-model.number="cItem.CalcValue"
                            :disabled="!formInline.alarmCheckbok.includes('指標告警')">
            ...
            <div style="margin-left: 70px">
              <el-form-item style="display: inline-block" label-width="0px">
                <el-select v-model="formInline.protocolValue" style="display: inline-block"
                  ...
                  <el-option v-for="(item, index) in protocol" :key="index" :label="item" :value="item"
                    label-width="40px"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item style="display: inline-block;margin-left: 10px" label-width="0px">
                <el-select filterable v-model="formInline.callbackVerifyCode" style="width: 300px">
                  <el-option v-for="item in formInline.protocolValue === 'http'
                      ? httpOption
                      : httpsOption" :key="item.VerifyCode" :label="item.website" :value="item.VerifyCode">
        ...
        configTriggerCalcValueValidator: [{
          validator: (rule, value, callback) => {
            if (this.radioChufa === '2') {
              ...
              for (let i = 0; i < index; i++) {
                if (Conditions[index].CalcValue === Conditions[i].CalcValue && Conditions[index].MetricId ===
                  Conditions[i].MetricId) {
                  callback(new Error('請勿重複配置'))
                  return
                }
              }
