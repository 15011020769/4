  ...
  export default {
    ...
    methods: {
      ...
      GetDat(data) {
        ...
        const symbol = ["Mbps", "Mbps", "个/秒", "个/秒", "百分比", "秒"];
        this.tableData = [];
    ...
    filters: {
      ...
      UpTitle(value) {
        if (value === "Outbandwidth") {
          return (value = "VPN通道平均每秒出流量");
        }
        if (value === "Inbandwidth") {
          return (value = "VPN通道平均每秒入流量");
        }
        if (value === "Outpkg") {
          return (value = "VPN通道平均每秒出包量");
        }
        if (value === "Inpkg") {
          return (value = "VPN通道平均每秒入包量");
        }
        if (value === "Pkgdrop") {
          return (value = "VPN探测一分钟的丢包比例");
        }
        if (value === "Delay") {
          return (value = "VPN探测一分钟的平均时延");
        }
        if (value === "") {
          return (value = "");
        }
