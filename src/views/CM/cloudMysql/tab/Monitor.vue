    ...
    data() {
      return {
        ...
        disName: {
          ...
          'InnodbCacheHitRate': 'innodb緩存命中率',
          'InnodbCacheUseRate': 'innodb緩存使用率',
          ...
          'KeyBlocksUnused': '鍵緩存內未使用的塊數量',
          'KeyBlocksUsed': '鍵緩存內使用的塊數量',
          'KeyCacheHitRate': 'myisam緩存命中率',
          ...
          'OpenFiles': '打開文件總數',
          'QcacheFreeBlocks': '查詢緩存空閑塊',
          'QcacheFreeMemory': '緩存中空閑內存量',
          'QcacheHits': '緩存命中次數',
          'QcacheHitRate': '緩存命中率',
          ...
          'SelectCount': '查詢數',
          'SelectScan': '全表掃描數',
          'SlaveIoRunning': 'IO線程狀態',
          'SlaveSqlRunning': 'SQL線程狀態',
          'SlowQueries': '慢查詢數',
